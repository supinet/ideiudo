...
import br.mil.eb.rm.ideiudo.util.cdi.report.ExecutorRelatorio;
import br.mil.eb.rm.ideiudo.util.jsf.FacesUtil;

@Named
@RequestScoped
public class RelatorioIdeiaProblemaBean implements Serializable {
	...
	public void emitir() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio(
				"/relatorio/ideiudo/ideia.jasper", this.response,
				parametros, "ideia.pdf");
